      ...
      if (isMultiResponse(res) && res.images.length > 1) {
        for (const img of res.images) {
          const item: GenerateItem = {
            ...
            revisedPrompt: img.revisedPrompt ?? res.revisedPrompt ?? null,
            promptMode: res.promptMode ?? s.promptMode,
            composerPrompt,
            composerInsertedPrompts,
            elapsed: res.elapsed,
            provider: res.provider,
        ...
        if (isMultiResponse(res)) {
          ...
          item = {
            ...
            prompt,
            userPrompt: composerPrompt || prompt,
            revisedPrompt: first.revisedPrompt ?? res.revisedPrompt ?? null,
            promptMode: res.promptMode ?? s.promptMode,
            composerPrompt,
            composerInsertedPrompts,
            elapsed: res.elapsed,
